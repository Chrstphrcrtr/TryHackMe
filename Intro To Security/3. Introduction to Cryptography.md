...
After entering the command we are prompted with a passphrase which is provided to us. Enter the passphrase `s!kR3T55` and we can see our Question1.txt is now outputted.
